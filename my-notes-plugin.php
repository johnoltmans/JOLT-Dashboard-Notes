...
function notes_dashboard_widget() {
    ...
    if ($notes->have_posts()) {
        ...
        while ($notes->have_posts()) {
            ...
            $view_link = admin_url('admin.php?page=view-note&note_id=' . get_the_ID());
            ...
            echo '<br><small>' . esc_html($excerpt) . ' <a href="' . esc_url($view_link) . '">Read more</a></small>';
            echo '</li><hr>';
        }
        echo '</ul>';
    } else {
